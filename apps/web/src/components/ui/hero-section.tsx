...
import { Card, AnimatedButton, gradients } from './design-system';
import { Brain, Camera, BarChart3, Sparkles, ArrowRight, Play } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Choose from multiple AI personalities with unique coaching styles',
      gradient: 'primary' as keyof typeof gradients
    },
    {
      icon: Camera,
      title: 'Real-time Form Analysis',
      description: 'Get instant feedback on your exercise form and technique',
      gradient: 'ocean' as keyof typeof gradients
    },
    {
      icon: BarChart3,
      title: 'Smart Progress Tracking',
      description: 'Advanced analytics and insights to track your fitness journey',
        ...
        >
          ...
          <motion.div variants={itemVariants} className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Experience the world's most advanced AI personal training platform. 
              Get personalized workouts, real-time form analysis, and intelligent coaching 
              that adapts to your progress.
            </p>
          </motion.div>

          {/* CTA Buttons */}
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-4 mb-16">
            ...
            <Link href="/automated-photo-capture">
              <AnimatedButton
                variant="ghost"
                size="lg"
                className="px-8 py-4 text-lg font-semibold border-2 border-gray-300"
              >
            ...
            {features.map((feature, index) => {
              ...
              return (
                <Card
                  ...
                  animation="slideUp"
                >
                  <div className={`w-16 h-16 ${gradients[feature.gradient]} rounded-full flex items-center justify-center mx-auto mb-4`}>
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { number: '∞', label: 'Workout Variations' },
