...
import { 
  ...
  PhotoCaptureStep,
  CapturedPhoto
} from '../../progress-tracking/services/progress-photo-capture-service';
import { userProfileService } from '../../progress-tracking/services/user-profile-service';
    ...
    if (!currentUser) {
      ...
      const sampleProfile = {
        ...
        privacySettings: {
          ...
          progressPhotos: 'private' as const,
          weightData: 'private' as const,
          workoutHistory: 'private' as const,
          achievements: 'private' as const
        },
        preferences: {
          workoutDuration: 30,
          workoutFrequency: 3,
          preferredWorkoutTime: 'evening' as const,
          voiceCoachStyle: 'motivational' as const,
          notifications: {
